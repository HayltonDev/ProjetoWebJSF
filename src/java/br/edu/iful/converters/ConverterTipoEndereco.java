 ...
 * @author Haylton
 */
@FacesConverter(value = "converterTipoEndereco") //essa anotação facesConverter vai ajudar para chamar o conversor lá na tela
public class ConverterTipoEndereco implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        //basicamente o que esse método vai fazer é pegar a string de parâmetro e transforma-lo em um objeto do tipo TipoEndereco

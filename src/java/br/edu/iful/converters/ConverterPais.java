 ...
 * @author Haylton
 */
@FacesConverter(value = "converterPais") //essa anotação facesConverter vai ajudar para chamar o conversor lá na tela
public class ConverterPais implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        //basicamente o que esse método vai fazer é pegar a string de parâmetro e transforma-lo em um objeto do tipo Pais
